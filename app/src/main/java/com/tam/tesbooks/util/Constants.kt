...
const val SIZE_BOOK_SCREEN_ITEMS_COUNT_WITH_NO_PARAGRAPHS = 2
const val SIZE_BOOK_SCREEN_ITEMS_BEFORE_PARAGRAPHS = 1
...
const val TEXT_REVERSE_SORT = "Reverse Sorting"
...
const val TEXT_BOOK_AUTHOR_INTRO = "Author:  "
